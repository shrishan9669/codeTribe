...
userRouter.post('/google-login',async(req:any,res:any)=>{
  try{
    ...
    const {token} = req.body ; // token is Google id_token from frontend
      ...
      if(!payload) return res.status(401).json({ok:false,msg:"Invalid google token"});
...
userRouter.get('/send-otp',async(req:any,res:any)=>{
...
userRouter.get('/User',Usermiddleware,async(req:any,res:any)=>{
      const {id} = req.user;
...
userRouter.post("/updatePassword",Usermiddleware,async(req:any,res:any)=>{
    const {id} = req.user;
...
userRouter.post("/updateProfile",Usermiddleware,async(req:any,res:any)=>{
    const {id} = req.user;
...
userRouter.post('/groups',Usermiddleware,async(req:any,res:any)=>{
  const {id} = req.user;
...
userRouter.get('/groups/my',Usermiddleware,async(req:any,res:any)=>{
    const {id} = req.user;
    if(!id){
      return res.status(401).json({
        ok:false,
...
userRouter.delete('/groups/removeMember',Usermiddleware,async(req:any,res:any)=>{
  const {id} = req.user;
...
userRouter.post('/groups/rolechange',Usermiddleware,async(req:any,res:any)=>{
  const {id} = req.user;
...
userRouter.get('/totalGroups',Usermiddleware,async(req:any,res:any)=>{
     const {id} = req.user;
...
userRouter.get('/groups/toJoin',Usermiddleware,async(req:any,res:any)=>{
  const {id} = req.user;
...
userRouter.get('/groups/:groupId',Usermiddleware,async(req:any,res:any)=>{
    const {id} = req.user;
    if(!id){
      return res.status(401).json({
        ok:false,
...
userRouter.delete('/groups/:groupId/delete',Usermiddleware,async(req:any,res:any)=>{
  const {id} = req.user;
   if(!id){
    return res.status(401).json({
      ok:false,
...
userRouter.delete('/groups/:groupId/leave',Usermiddleware,async(req:any,res:any)=>{
  const {id} = req.user;
...
userRouter.get('/groups/:groupId/members',Usermiddleware,async(req:any,res:any)=>{
   const {id} = req.user;
...
userRouter.post('/groups/:groupId/join',Usermiddleware,async(req:any,res:any)=>{
  const {id} = req.user;
   if (!id) {
      return res.status(401).json({
        ok: false,
...
userRouter.post('/groups/:groupId/changeisPublic',Usermiddleware,async(req:any,res:any)=>{
    const {id} = req.user;
   if (!id) {
      return res.status(401).json({
        ok: false,
...
userRouter.post("/groups/:groupId/leaveAdminship",Usermiddleware,async(req:any,res:any)=>{
   const {id} = req.user;
   if (!id) {
      return res.status(401).json({
        ok: false,
...
userRouter.get('/personal',Usermiddleware,async(req:any,res:any)=>{
    const {id} = req.user;
    if (!id) {
        return res.status(401).json({
          ok: false,
...
// create room
userRouter.post('/rooms/:groupId/create-room',Usermiddleware,async(req:any,res:any)=>{
    const {id} = req.user
...
userRouter.get('/rooms/:groupId/code',Usermiddleware,async(req:any,res:any)=>{
    const {id} = req.user
...
userRouter.put('/rooms/:groupId/putCode',Usermiddleware,async(req:any,res:any)=>{
  const {id} = req.user
...
userRouter.post('/rooms/:groupId/version',Usermiddleware,async(req:any,res:any)=>{
   const {id} = req.user
...
userRouter.get('/rooms/:groupId/versionHistory',Usermiddleware,async(req:any,res:any)=>{
   const {id} = req.user
...
userRouter.put('/changeAdmin',async(req:any,res:any)=>{
